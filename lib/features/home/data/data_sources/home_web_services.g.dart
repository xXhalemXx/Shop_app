...
class _HomeWebServices implements HomeWebServices {
  ...
  Future<AddOrDeleteResponse> addOrDeleteFav(
    AddOrDeleteBody addOrDeleteBody,
    String contentType,
    String lang,
    String authorization,
  ) async {
    ...
    _data.addAll(addOrDeleteBody.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AddOrDeleteResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = AddOrDeleteResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<CategoryModel> getCategory(String lang) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
